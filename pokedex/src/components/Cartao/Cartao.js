...
import { goToDetails } from "../../rotas/coordinator";
import { MainCard, DetalheLink, ImageTypes, Loading } from "./Style"
import { PokeImage, CatchPokemon, Cards, DeletarPokemon } from "./Style"
...
<Cards>
  ...
  <DeletarPokemon onClick={()=>context.removePokemonPokedex(props.pokemon)}>Excluir!</DeletarPokemon>}
    </DetalheLink>  
</MainCard> }
</>
);
